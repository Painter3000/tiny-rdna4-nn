...
MARKER = "TCNN_RDNA4_P4A3_Q0C_TEST_ONLY_BINDING_HOOK_001"
...
METHOD = r'''
	// TCNN_RDNA4_P4A3_Q0C_TEST_ONLY_BINDING_HOOK_001
...
PYBIND = (
    '\t\t.def("fwd", &Module::fwd)\n'
    '\t\t.def("phase4a3_q0c_benchmark_inference", '
    '&Module::phase4a3_q0c_benchmark_inference)\n'
)
...
def main() -> int:
    ...
    if args.mode == "restore":
        ...
        print("PHASE4A3_Q0C_BINDING_RESTORED: PASS")
        return 0

    text = args.file.read_text()
    if MARKER in text:
        raise RuntimeError("Q0c marker already present")
    ...
    if MARKER not in text:
        raise RuntimeError("Q0c marker insertion failed")
    print("PHASE4A3_Q0C_TEST_ONLY_BINDING_PATCH: PASS")
    return 0
