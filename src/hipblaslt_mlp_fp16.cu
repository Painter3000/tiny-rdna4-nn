...
enum class FEpi:uint8_t{Bias,ReluBias};
struct FKey {
...
uint64_t hipblaslt_fp16_scratch_bytes_live(){return 0;}uint64_t hipblaslt_fp16_scratch_bytes_peak(){return 0;}
